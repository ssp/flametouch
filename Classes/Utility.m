...
-(id)init {
  ...
  self.serviceNames = [NSDictionary dictionaryWithObjectsAndKeys:
                       ...
                       @"Jini Service</b> Discovery", @"_jini._tcp.",
                       ...
                       @"MoneyWorks Gold and MoneyWorks Datacentre network service</b>", @"_moneyworks._tcp.",
                       ...
                       @"American Dynamics Intellex Archive Management Service</b>", @"_ntlx-arch._tcp.",
                       @"American Dynamics Intellex Enterprise Management Service</b>", @"_ntlx-ent._tcp.",
                       @"American Dynamics Intellex Video Service</b>", @"_ntlx-video._tcp.",
                       ...
                       @"Community Service</b>", @"_resacommunity._tcp.",
                       @"RESOL VBus", @"_resol-vbus._tcp.",
                       @"Retrospect backup and restore service</b>", @"_retrospect._tcp.",
                       @"Remote Frame Buffer (used by <a href=\"http://www.realvnc.com/\">VNC</a>)", @"_rfb._tcp.",
                       ...
                       @"Salling Clicker Service</b>", @"_sallingclicker._tcp.",
                       @"Salutafugi Peer-To-Peer Java Message Service</b> Implementation", @"_salutafugijms._tcp.",
